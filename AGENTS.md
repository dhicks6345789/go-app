...
Copy index.html to ~/www/go-app, where it will be served by the system webserver. Copy the API documentation to that location as well, making sure there is a link in index.html to it.
